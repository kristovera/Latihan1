...
public class HapusMhsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //variabel
        EditText buttonEdit = (EditText)findViewById(R.id.EditTextHapusMhs);
        final Button buttonHapusMhs = (Button)findViewById(R.id.Hapus);
        ...
        buttonHapusMhs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<DefaultResult> call = service.delete_mhs(
                        buttonHapusMhs.getText().toString(),"72180205"
                );
